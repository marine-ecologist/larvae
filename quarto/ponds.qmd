...
### Inset larval culture locations per year

```{r fig.height=20, fig.width=20, show=FALSE, warning=FALSE, message=FALSE}
#| echo: false
#| column: page
...
pool_sf <- rbind(pool_2021,pool_2022,pool_2023,pool_2024)

tmap_mode("view")

tm_shape(pool_sf |> 
           mutate(year=as.factor(year))) +
  tm_symbols(fill ="year", 
